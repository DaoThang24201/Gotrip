                        ...
                        <div class="row y-gap-20 pt-30">
                            ...
                            <div class="col-lg-3 col-6">
                                <div class="text-center">
                                    <i class="{{$property->icon}} text-24 text-blue-1"></i>
                                    <div class="text-15 lh-1 mt-10">{{$property->name}}</div>
                                </div>
                            </div>
                            @endforeach
                ...
                <div class="ml-50 lg:ml-0">
                    <div class="px-30 py-30 border-light rounded-4 shadow-4">
                        <div class="d-flex items-center justify-between">
                            <div class="">
                                <span class="text-20 fw-500">US${{$hotel->price}}</span>
                            ...
                            <div class="d-flex items-center">
                                <div class="text-14 text-right mr-10">
                                    ...
                                    <div class="lh-15 text-light-1">{{count($hotel->reviews)}} reviews</div>
                                </div>
